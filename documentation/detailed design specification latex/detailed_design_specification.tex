...
\begin{figure}[h!]
	\centering
   	\includegraphics[width=0.60\textwidth]{images/logo12}
\end{figure}
\vspace{0.5 in}
...
\input{tex/client_layer_subsystems.tex}
\newpage

\section{Server Layer Subsystems}
\input{tex/server_layer_subsystems.tex}
\newpage

\section{Hardware Interface Specifications}
\input{tex/hardware_interface.tex}
\newpage
